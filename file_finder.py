...
def file_exists():
    ...
    filenames = [file.name for file in mydir.iterdir()
                 if file.name.startswith('HiTrack') and not file.name.endswith("json")]
    file_paths = [file for file in mydir.iterdir()
                  if file.name.startswith('HiTrack') and not file.name.endswith("json")]


    if not filenames:
        print("There are no huawei files in folder. Place HiTrack files into folder : ..\\HiRunnerExtended\\Example \n"
...
for j in itertools.islice(dfr, 0, None):
    ...
    if j[0].startswith('tp=p-m') or j[0].startswith('tp=s-r') or j[0].startswith('tp=rs') or j[0].startswith('tp=rp'):
        x = re.split(';|=', j[0])
        tpe.append(x)
    ...
    for j in itertools.islice(tpe, 0, None):
        ...
        if j[0] == "extended":
          ...
          #  dictt["timestampunits"] = "s"
            ...
            elif int(j[12]) == 0 and int(j[14]) < int(j[16]) or int(j[14]) == int(j[16] != 0):
                # od 11 do 16
...
df3 = pd.DataFrame(columns=["Type", "Local Number", "Message", "Field 1", "Value 1", "Units 1",
                            "Field 2", "Value 2", "Units 2",
                            "Field 3", "Value 3", "Units 3", "Field 4", "Value 4", "Units 4",
                            "Field 5", "Value 5", "Units 5", "Field 6", "Value 6", "Units 6", "Field 7", "Value 7",
                            "Units 7",
                            "Field 8", "Value 8", "Units 8", "Field 9", "Value 9", "Units 9",
                            "Field 10", "Value 10", "Units 10"])
valuedf2 = ["Definition", "0", "file_id", "type", "1", "",
            "manufacturer", "1", "",
            "product", "1", "", "time_created", "", "",
            "serial_number", "1", "", "number", "1", "", "", "", "",
            "", "", "", "", "", "",
            "", "", ""]
valuedf3 = ["Data", "0", "file_id", "type", "4", "",
            "manufacturer", "0", "",
            "product", "0", "", "time_created", "930702435", "",
            "", "", "", "", "", "", "", "", "",
            "", "", "", "", "", "",
            "", "", ""]
valuedf4 = ["Definition", "0", "file_creator", "software_version", "1", "",
            "hardware_version", "1", "",
            "", "", "", "", "", "",
            "", "", "", "", "", "", "", "", "",
            "", "", "", "", "", "",
            "", "", ""]
valuedf5 = ["Data", "0", "file_creator", "software_version", "100", "",
            "", "", "",
            "", "", "", "", "", "",
            "", "", "", "", "", "", "", "", "",
            "", "", "", "", "", "",
            "", "", ""]
valuedf6 = ["Definition", "0", "event", "timestamp", "1", "",
            "event", "1", "",
            "event_type", "1", "", "data", "1", "",
            "event_group", "1", "", "", "", "", "", "", "",
            "", "", "", "", "", "",
            "", "", ""]
valuedf7 = ["Data", "0", "event", "timestamp", "930702435", "s",
            "event", "0", "",
            "event_type", "0", "", "timer_trigger", "0", "",
            "event_group", "0", "", "", "", "", "", "", "",
            "", "", "", "", "", "",
            "", "", ""]
valuedf8 = ["Definition", "0", "developer_data_id", "application_id", "16", "",
            "developer_data_index", "1", "",
            "application_version", "1", "", "", "", "",
            "", "", "", "", "", "", "", "", "",
            "", "", "", "", "", "",
            "", "", ""]
valuedf9 = ["Data", "0", "developer_data_id", "application_id", "3|2|1|0|5|4|7|6|8|9|10|11|12|13|14|15", "",
            "developer_data_index", "0", "",
            "application_version", "110", "", "", "", "",
            "", "", "", "", "", "", "", "", "",
            "", "", "", "", "", "",
            "", "", ""]
valuedf10 = ["Definition", "0", "field_description", "developer_data_index", "1", "",
             "field_definition_number", "1", "",
             "fit_base_type_id", "1", "", "field_name", "17", "",
             "units", "10", "", "native_mesg_num", "", "", "", "", "",
             "", "", "", "", "", "",
             "", "", ""]
valuedf11 = ["Data", "0", "field_description", "developer_data_index", "0", "",
             "field_definition_number", "0", "",
             "fit_base_type_id", "136", "", "field_name", "Doughnuts Earned", "",
             "units", "doughnuts", "", "native_mesg_num", "18", "", "", "", "",
             "", "", "", "", "", "",
             "", "", ""]
valuedf12 = ["Definition", "0", "field_description", "developer_data_index", "1", "",
             "field_definition_number", "1", "",
             "fit_base_type_id", "1", "", "field_name", "20", "",
             "units", "8", "", "native_mesg_num", "1", "", "", "", "",
             "", "", "", "", "", "",
             "", "", ""]
valuedf13 = ["Data", "0", "field_description", "developer_data_index", "0", "",
             "field_definition_number", "2", "",
             "fit_base_type_id", "136", "", "field_name", "pronation_excursion", "",
             "units", "degrees", "", "native_mesg_num", "20", "", "", "", "",
             "", "", "", "", "", "",
             "", "", ""]
valuedf14 = ["Data", "0", "field_description", "developer_data_index", "0", "",
             "field_definition_number", "3", "",
             "fit_base_type_id", "136", "", "field_name", "pitch_excursion", "",
             "units", "degrees", "", "native_mesg_num", "20", "", "", "", "",
             "", "", "", "", "", "",
             "", "", ""]
valuedf15 = ["Data", "0", "field_description", "developer_data_index", "0", "",
             "field_definition_number", "4", "",
             "fit_base_type_id", "136", "", "field_name", "impact_gs", "",
             "units", "gs", "", "native_mesg_num", "20", "", "", "", "",
             "", "", "", "", "", "",
             "", "", ""]
valuedf16 = ["Data", "0", "field_description", "developer_data_index", "0", "",
             "field_definition_number", "5", "",
             "fit_base_type_id", "136", "", "field_name", "footstrike_type", "",
             "units", "type", "", "native_mesg_num", "20", "", "", "", "",
             "", "", "", "", "", "",
             "", "", ""]
valuedf17 = ["Definition", "0", "field_description", "developer_data_index", "1", "",
             "field_definition_number", "1", "",
             "fit_base_type_id", "1", "", "field_name", "11", "",
             "units", "4", "", "native_field_num", "1", "", "native_mesg_num", "1", "",
             "", "", "", "", "", "",
             "", "", ""]
valuedf18 = ["Data", "0", "field_description", "developer_data_index", "0", "",
             "field_definition_number", "1", "",
             "fit_base_type_id", "2", "", "field_name", "Heart Rate", "",
             "units", "bpm", "", "native_field_num", "3", "", "native_mesg_num", "20", "",
             "", "", "", "", "", "",
             "", "", ""]
valuedf19 = ["Definition", "0", "record", "timestamp", "1", "",
             "speed", "1", "",
             "stance_time", "1", "", "pronation_excursion", "1", "",
             "pitch_excursion", "1", "", "impact_gs", "1", "", "footstrike_type", "1", ""]
...
df3 = df3.append(pd.Series(valuedf19, index=df3.columns[:len(valuedf19)]), ignore_index=True)
...
for index, row in df2.iterrows():
    df_length = len(df3)
    df4= ["Data", "0", "record", "timestamp", index, "s",
     "speed", row[1], "m/s",
     "stance_time", row[2], "ms", "pronation_excursion", row[3], "degrees",
     "pitch_excursion", row[4], "degrees", "impact_gs", row[5], "gs",
     "footstrike_type", row[6], "type"]
